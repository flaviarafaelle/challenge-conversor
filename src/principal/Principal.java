...
public class Principal {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String opcao = JOptionPane.showInputDialog(null, "Escolha uma opção ", "Menu", JOptionPane.PLAIN_MESSAGE, null, new Object[]{
                "Conversor de Moeda", "Conversor de Temperatura"}, "Escolha").toString();
